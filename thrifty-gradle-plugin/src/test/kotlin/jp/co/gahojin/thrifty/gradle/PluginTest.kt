...
import jp.co.gahojin.thrifty.gradle.ThriftyGradlePlugin.Companion.loadVersionProps
...
class PluginTest {
    ...
    private fun buildFixtureWithSubprojectsAndTask(
        ...
        settings.bufferedWriter(Charsets.UTF_8).use {
            ...
            it.appendLine("    id 'jp.co.gahojin.thrifty' version '${thriftyVersion}'")
            ...
            it.appendLine("      library('thrifty-runtime', 'jp.co.gahojin.thrifty', 'thrifty-runtime').versionRef('thrifty')")
            it.appendLine("      library('thrifty-compilerPlugins', 'jp.co.gahojin.thrifty', 'thrifty-compiler-plugins').versionRef('thrifty')")
            it.appendLine("    }")
            it.appendLine("  }")
            it.appendLine("}")
