...
class LoaderTest {
    ...
    fun basicTest() {
        val thrift = """
            namespace java jp.co.gahojin.thrifty.test
    ...
    fun oneInclude() {
        val included = """
            namespace java jp.co.gahojin.thrifty.test.include
    ...
    fun includedTypesMustBeScoped() {
        ...
        val included = """
            namespace java jp.co.gahojin.thrifty.test.scopedInclude
    ...
    fun crazyIncludes() {
        ...
        val a = """
            namespace java jp.co.gahojin.thrifty.test.crazyIncludes
    ...
    fun crazyIncludeReferencedConst() {
        ...
        fileNestedAThrift.writeText(
            """
                namespace java jp.co.gahojin.thrifty.test.crazyIncludeReferencedConst
    ...
    fun includesWithRelativePaths() {
        ...
        val a = """
            namespace java jp.co.gahojin.thrifty.test.includesWithRelativePaths
