...
class ThriftParserTest {
    ...
    @Test
    fun namespaces() {
        val thrift = "namespace java jp.co.gahojin.thrifty.parser\n" +
                "namespace cpp gahojin.thrifty\n" +
                "namespace * gahojin.thrifty\n" +
        ...
        val expected = ThriftFileElement(
                ...
                namespaces = listOf(
                        NamespaceElement(
                                ...
                                namespace = "jp.co.gahojin.thrifty.parser"
                        ),
                        NamespaceElement(
    ...
    fun includes() {
        ...
        val expected = ThriftFileElement(
                ...
                namespaces = listOf(
                        NamespaceElement(location.at(5, 1), NamespaceScope.ALL, "gahojin")
                )
        )
    ...
    fun `jvm namespaces fall back to JVM declaration`() {
        val thrift = "namespace jvm jp.co.gahojin.thrifty.parser"
    ...
    fun `jvm namespaces fall back to JVM declaration but not if specified`() {
        val thrift = "namespace jvm jp.co.gahojin.thrifty.parser\nnamespace java jp.co.gahojin.thrifty.parser.java\n"
        ...
        val expected = ThriftFileElement(
            ...
            namespaces = listOf(
                ...
                NamespaceElement(
                    location = location.at(2, 1),
                    scope = NamespaceScope.JAVA,
                    namespace = "jp.co.gahojin.thrifty.parser.java"
                ),
                NamespaceElement(
                    location = location.at(1, 1),
                    scope = NamespaceScope.KOTLIN,
